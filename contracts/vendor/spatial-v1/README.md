...
Le [contrat caméra et CRS canonique](https://github.com/fireviewer/Fireviewer_doc/blob/main/repositories/fireviewer-spatial/docs/CAMERA_AND_CRS_CONTRACT.md)
constitue la référence normative actuelle. Cette copie vendue du profil v1 reste une fixture de
compatibilité : ses valeurs de contrôle ne constituent pas une source de géodonnées ni une
tentative de localisation événementielle.
